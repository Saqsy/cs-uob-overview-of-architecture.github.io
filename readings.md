...
**Introduction to Compilers and Language Design** (2023) by Douglas Thain. For our purposes, this book is very interesting but almost entirely overkill - it's a start-to-finish guide to designing your own high-level language and writing a well-optimised compiler for it. We're planning to reference a couple of chapters for introductory concepts, but for the most part this is a book to check out if you want to take a closer look at some of the theoretical concepts we'll be sweeping under the rug in the name of covering more material (particularly if you have a mathematical background). It's available for free from the author's website [here](https://www3.nd.edu/~dthain/compilerbook/).

*** TODO *** Strongly consider recommending **Crafting Interpreters** (2021) by Robert Nystrom. It takes a similar line to Thain but is much, much less overkill. It's also more tied into making its own language though so there are question marks about to what extent it can be made to fit. It's available for free from the author's website [here](https://craftinginterpreters.com/contents.html).
